 ...
 */
!function (t, e) {
    "object" == typeof exports && "undefined" != typeof module ? e(exports, require("../angular/angular")) : "function" == typeof define && define.amd ? define(["exports", "../angular/angular"], e) : e(t["@uirouter/angularjs"] = {}, t.angular)
}(this, function (d, t) {
    "use strict";
    var e = angular, b = t && t.module ? t : e;

    function c(r) {
        var t = [].slice.apply(arguments, [1]), n = r.length;
        return function t(e) {
    ...
    var u = Object.prototype.toString, g = function (e) {
        return function (t) {
            return typeof t === e
        }
    }, _ = g("undefined"), E = l(_), S = function (t) {
        return null === t
    }, $ = i(S, _), C = g("function"), T = g("number"), P = g("string"), k = function (t) {
        return null !== t && "object" == typeof t
    }, O = Array.isArray, x = function (t) {
    ...
    var I = n(k, s(w("then"), C)), H = function (n, t) {
            return t.reduce(function (t, e) {
        ...
        q = D.angular || {}, U = q.fromJson || JSON.parse.bind(JSON), F = q.toJson || JSON.stringify.bind(JSON),
        N = q.forEach || function (e, r, t) {
            if (O(e)) return e.forEach(r, t);
            Object.keys(e).forEach(function (t) {
                return r(e[t], t)
            })
        }, L = Object.assign || Pt, M = q.equals || kt;
    ...
    function $t(r, n) {
        return void 0 === n && (n = "assert failure"), function (t) {
            var e = r(t);
    ...
    function Ft(t) {
        var e = Nt(t), r = e.match(/^(function [^ ]+\([^)]*\))/), n = r ? r[1] : e, i = t.name || "";
    ...
    var Lt = At.isRejectionPromise,
        Mt = m([[_, v("undefined")], [S, v("null")], [I, v("[Promise]")], [Lt, function (t) {
    ...
    }, Wt = new RegExp("^(?:[a-z]+:)?//[^/]+/"), zt = function (t) {
        return t.replace(/\/[^/]*$/, "")
    }, Jt = Gt("#"), Qt = Gt("?"), Kt = Gt("="), Yt = function (t) {
        return t ? t.replace(/^#/, "") : ""
    };
    ...
    var oe = R("$id"), ae = R("router.$id"), ue = function (t) {
        ...
        return t.prototype._set = function (e, t) {
            ...
            if (this.enabled(d.Category.VIEWCONFIG)) {
                var a = "uiview component fqn", e = t.map(function (t) {
                    var e, r = t.uiView, n = t.viewConfig, i = r && r.fqn,
    ...
    function le(n, i) {
        ...
        ["encode", "decode", "equals", "$normalize"].forEach(function (t) {
            var e = n[t].bind(n), r = "equals" === t ? s : u;
            o[t] = r(e)
        }), L(this, {
            dynamic: n.dynamic,
            name: n.name,
    ...
    var he, pe = Object.prototype.hasOwnProperty, ve = function (t) {
        return 0 === ["value", "type", "squash", "array", "dynamic"].filter(pe.bind(t || {})).length
    };

    function de(t, e, r) {
        var n = !1 === r.reloadOnSearch && e === d.DefType.SEARCH || void 0, i = st([r.dynamic, n], E),
            o = E(i) ? {dynamic: i} : {}, a = function (t) {
                function e() {
                    return t.value
                }
    ...
    var me, ye = function () {
        function n(t, e, r, n, i) {
            ...
            var a, u,
                s = (a = {array: r === d.DefType.SEARCH && "auto"}, u = t.match(/\[\]$/) ? {array: !0} : {}, L(a, u, o).array);
            e = s ? e.$asArray(s, r === d.DefType.SEARCH) : e;
            var c = void 0 !== o.value || r === d.DefType.SEARCH, f = E(o.dynamic) ? !!o.dynamic : !!e.dynamic,
                l = E(o.raw) ? !!o.raw : !!e.raw, h = function (t, e, r) {
                    var n = t.squash;
                    if (!e || !1 === n) return !1;
                    if (!E(n) || null == n) return r;
                    if (!0 === n || P(n)) return n;
                    throw new Error("Invalid squash policy: '" + n + "'. Valid policies: false, true, or arbitrary string")
                }(o, c, n.defaultSquashPolicy()), p = function (t, e, r, n) {
                ...
                }(o, s, c, h), v = E(o.inherit) ? !!o.inherit : !!e.inherit;
            L(this, {
                id: t,
                type: e,
                location: r,
        ...
        return t.prototype.dispose = function () {
            ...
            return this.types[t] = new fe(L({name: t}, e)), r && (this.typeQueue.push({
                name: t,
                def: r
    ...
    me = function (t) {
        var e = function (t) {
            ...
            encode: e, decode: e, is: p(String), pattern: /.*/, equals: function (t, e) {
                return t == e
            }
        };
        return L({}, r, t)
    ...
    var we = function () {
            ...
            return t.prototype.$inherit = function (t, e, r) {
                var n, i = nt(e, r), o = {}, a = [];
                for (var u in i) if (i[u] && i[u].params && (n = Object.keys(i[u].params)).length) for (var s in n) 0 <= a.indexOf(n[s]) || (a.push(n[s]), o[n[s]] = this[n[s]]);
                return L({}, o, t)
            }, t
        }(), _e = function () {
            function n(t) {
                if (t instanceof n) {
                    ...
                    var r = t;
                    this.state = r, this.paramSchema = r.parameters({inherit: !1}), this.paramValues = {}, this.resolvables = r.resolvables.map(function (t) {
                        return t.clone()
                    })
                }
            }
            ...
            return h.makeTargetState = function (t, e) {
                ...
                o.filter(function (t) {
                    ...
                    var t = lt(e.state.views || {}), r = h.subPath(o, function (t) {
                        return t === e
                    }), n = t.map(function (t) {
                ...
                return t.map(function (t) {
                    var e = L({}, t && t.paramValues), r = it(e, c);
                    e = ot(e, c);
        ...
        Re = {when: "LAZY", async: "WAIT"}, Ee = function () {
            function a(t, e, r, n, i) {
                if (this.resolved = !1, this.promise = void 0, t instanceof a) L(this, t); else if (C(e)) {
            ...
            return a.prototype.getPolicy = function (t) {
                ...
                var n = this, t = A.$q, i = e.findNode(this), o = i && i.state,
        ...
        }(), Ce = be.when, Te = [Ce.EAGER, Ce.LAZY], Pe = [Ce.EAGER], ke = "Native Injector", Oe = function () {
            function t(t) {
                this._path = t
            }
            ...
            return t.prototype.getTokens = function () {
                ...
                var r = st(this._path, y("state", e)), n = t.map(function (t) {
                    return t.token
                });
                ...
                var f = function (e, r) {
                    ...
                    var r = e.resolvables.filter(f(c, "when")), n = r.filter(f(["NOWAIT"], "async")),
                        i = r.filter(l(f(["NOWAIT"], "async"))), o = s.subContext(e.state), a = function (e) {
                ...
                var n = this, r = this.findNode(e), i = ($e.subPath(this._path, function (t) {
                    return t === r
    ...
    var He = function (o, a) {
        return function (t) {
            ...
            var r = t.parent, n = function (t) {
                if (!P(t)) return !1;
                var e = "^" === t.charAt(0);
                return {val: e ? t.substring(1) : t, root: e}
            }(e.url), i = n ? o.compile(n.val, {state: e}) : e.url;
            if (!i) return null;
    ...
    var Ue, Fe, Ne = function () {
        function t(e, t) {
            ...
            this.builders = {
                name: [je], self: [Ve], parent: [function (t) {
                    return a(t) ? null : e.find(i.parentName(t)) || o()
                }], data: [Ie], url: [He(t, o)], navigable: [(r = a, function (t) {
                ...
                })], views: [], path: [Ae], includes: [De], resolvables: [qe]
            }
        }
        ...
        return t.prototype.builder = function (t, e) {
            ...
            var e = this.matcher, r = this.builders, n = this.parentName(t);
        ...
        return r.create = function (t) {
            ...
            return t.$$state = function () {
                return e
            }, e.self = t, e.__stateObjectCache = {nameGlob: Vt.fromString(e.name)}, e
        ...
        return t.prototype.isRelative = function (t) {
            ...
            for (var r = this.find(e), n = t.split("."), i = n.length, o = 0, a = r; o < i; o++) if ("" !== n[o] || 0 !== o) {
                if ("^" !== n[o]) break;
        ...
        return t.prototype.dispose = function () {
            ...
            var e = this.queue, r = Le.create(t), n = r.name;
            ...
            for (var e = this, t = this.queue, r = this.states, n = this.builder, i = [], o = [], a = {}, u = function (t) {
                ...
                var c = t.shift(), f = c.name, l = n.build(c), h = o.indexOf(c);
                if (l) {
                    var p = u(f);
        ...
        return t.prototype._registerRoot = function () {
            ...
            var r = this, n = this.get().map(function (t) {
                return t.$$state()
            }), i = function (e) {
    ...
    var We = {current: G, transition: null, traceData: {}, bind: null}, ze = function () {
        function o(t, e, r, n) {
            var i = this;
        ...
        return o.chain = function (t, e) {
            ...
            var e = this, r = this.registeredHook;
            if (!r._deregistered) {
            ...
            var t = this.options, e = this.registeredHook;
    ...
    var Qe = function () {
        ...
        return t.prototype._matchingNodes = function (t, e) {
            ...
            var a = this, u = L(this._getDefaultMatchCriteria(), this.matchCriteria);
            return lt(this.tranSvc._pluginapi._getPathTypes()).reduce(function (t, e) {
                var r = e.scope === d.TransitionHookScope.STATE, n = o[e.name] || [], i = r ? n : [Ct(n)];
    ...
    function Ke(t, i, o) {
        var a = (t._registeredHooks = t._registeredHooks || {})[o.name] = [], u = K(a);
    ...
    var Ye = function () {
        ...
        return t.prototype.buildHooksForPhase = function (t) {
            ...
            var a = this.transition, t = a.treeChanges(), e = this.getMatchingHooks(o, t);
            if (!e) return [];
            ...
            return e.map(function (i) {
                ...
                void 0 === i && (i = !1);
                return function (t, e) {
                    var r = i ? -1 : 1, n = (t.node.state.path.length - e.node.state.path.length) * r;
            ...
            var t = e.hookPhase === d.TransitionHookPhase.CREATE, n = this.transition.router.transitionService;
    ...
    var Ze = w("self"), Xe = function () {
        ...
        return e.prototype.onBefore = function (t, e, r) {
            ...
            var t = this.params("from"), r = this.params("to"),
            ...
            var r = "string" == typeof e ? e : e.name, n = this._treeChanges.to, i = st(n, function (t) {
            ...
            for (var e = 1, r = this; null != (r = r.redirectedFrom());) if (20 < ++e) throw new Error("Too many consecutive Transition redirects (20+)");
            ...
            t = t.withOptions(i, !0);
            var o, a = this.router.transitionService.create(this._treeChanges.from, t), u = this._treeChanges.entering,
            ...
            var t = this.router.globals.transition, n = this._options.reloadState, e = function (t, e) {
            ...
            if (n.length) {
                ...
                }).join(", "), o = "The following parameter values are not valid for state '" + t.name + "': " + i;
                return At.invalid(o)
            }
    ...
    var er = Zt("/"), rr = {state: {params: {}}, strict: !0, caseInsensitive: !0}, nr = function () {
        function m(o, a, t, e) {
            var u = this;
            this._cache = {path: [this]}, this._children = [], this._params = [], this._segments = [], this._compiled = [], this.config = e = et(e, rr), this.pattern = o;
            for (var r, n, i, s = /([:*])([\w\[\]]+)|\{([\w\[\]]+)(?:\:\s*((?:[^{}\\]+|\\.|\{(?:[^{}\\]+|\\.)*\})+))?\}/g, c = /([:]?)([\w\[\].-]+)|\{([\w\[\].-]+)(?:\:\s*((?:[^{}\\]+|\\.|\{(?:[^{}\\]+|\\.)*\})+))?\}/g, f = [], l = 0, h = function (t) {
                ...
                var r, n = t[2] || t[3], i = e ? t[4] : t[4] || ("*" === t[1] ? "[\\s\\S]*" : null);
                return {
                    id: n,
                    regexp: i,
                    segment: o.substring(l, t.index),
                    type: i ? a.type(i) || (r = i, z(a.type(e ? "query" : "path"), {pattern: new RegExp(r, u.config.caseInsensitive ? "i" : void 0)})) : null
                }
            ...
            if (0 <= v) {
                var d = i.substring(v);
                if (i = i.substring(0, v), 0 < d.length) for (l = 0; r = c.exec(d);) h((n = p(r, !0)).id), this._params.push(t.fromSearch(n.id, n.type, e.state)), l = s.lastIndex
            }
        ...
        return m.encodeDashes = function (t) {
            ...
            if (!s) return null;
            var c, f = this.parameters(), l = f.filter(function (t) {
                return !t.isSearch()
            ...
            void 0 === a && (a = {});
            var t = this._cache.path, e = t.map(m.pathSegmentsAndParams).reduce(vt, []).map(function (t) {
                return P(t) ? t : n(t)
            ...
            function n(t) {
                var e = t.value(a[t.id]), r = t.validates(e), n = t.isDefaultValue(e), i = !!n && t.squash,
                    o = t.type.encode(e);
            ...
            var i = e.reduce(function (t, e) {
                if (P(e)) return t + e;
                var r = e.squash, n = e.encoded, i = e.param;
        ...
        return t.prototype.compile = function (t, e) {
            var r = this.router.urlService.config, n = e && !e.state && e.params;
        ...
        return t.prototype.compile = function (t) {
            ...
            var r = this, n = Le.isState, i = m([[P, function (t) {
            ...
            var n = {
                urlMatcher: r, matchPriority: function (e) {
            ...
            return L(this.fromUrlMatcher(n.url, function (t) {
                var e = i.stateService, r = i.globals;
    ...
    var cr, fr = function () {
        ...
        function s(t) {
            ...
            this.router = t, this._uiViews = [], this._viewConfigs = [], this._viewConfigFactories = {}, this._listeners = [], this._pluginapi = {
                ...
                _onSync: function (t) {
                    return r._listeners.push(t), function () {
        ...
        return s.normalizeUIViewTarget = function (t, e) {
            void 0 === e && (e = "");
            var r = e.split("@"), n = r[0] || "$default", i = P(r[1]) ? r[1] : "^", o = /^(\^(?:\.\^)*)\.(.*$)/.exec(n);
            ...
            var r = this, n = this._uiViews.map(function (t) {
                return [t.fqn, t]
            }).reduce(Et, {});
            ...
            }).length && ce.traceViewServiceUIViewEvent("!!!! duplicate uiView named:", e), t.push(e), this.sync(), function () {
            ...
            return function (t) {
                ...
                var e = t.viewDecl, r = e.$uiViewName.split("."), n = s.fqn.split(".");
                if (!M(r, n.slice(0 - r.length))) return !1;
                var i = 1 - r.length || void 0, o = n.slice(0, i).join("."), a = u[o].creationContext;
    ...
    var vr = function () {
            ...
            return t.prototype.dispose = function () {
                ...
                if (!t || !t.defaultPrevented) {
                    var e = this.router, r = e.urlService, n = e.stateService,
        ...
        }(), yr = 0, gr = H("LocationServices", ["url", "path", "search", "hash", "onChange"]),
    ...
    var $r = J(["$transition$", Xe]), br = function (t) {
        var e = lt(t.treeChanges()).reduce(vt, []).reduce(yt, []), r = function (t) {
    ...
    var Cr = Er("onExit"), Tr = Er("onRetain"), Pr = Er("onEnter"), kr = function (t) {
        ...
        return A.$q.all(t).then(function () {
            ...
            var e = u.urlService, r = e.match(e.parts()), n = r && r.rule;
            if (n && "STATE" === n.type) {
                var i = n.state, o = r.match;
    ...
    function Dr(e, r) {
        var n = r.$$state().lazyLoad, t = n._promise;
        if (!t) {
    ...
    var Nr = {
        ...
        return t.prototype.onCreate = function (t, e, r) {
            ...
            var t = d.TransitionHookPhase, e = ze, r = this._criteriaPaths;
            ...
            var t = d.TransitionHookScope.STATE, e = d.TransitionHookScope.TRANSITION;
            ...
            t.addCoreResolves = this.onCreate({}, Sr), t.ignored = this.onBefore({}, Ur, {priority: -9999}), t.invalid = this.onBefore({}, Fr, {priority: -1e4}), t.redirectTo = this.onStart({
                to: function (t) {
                    return !!t.redirectTo
                }
        ...
        return Object.defineProperty(r.prototype, "transition", {
            ...
            var n = this, i = $e.makeTargetState(this.router.stateRegistry, t), e = this.router.globals,
                o = function () {
                    return e.transitionHistory.peekTail()
                }, a = o(), u = new It(this.invalidCallbacks.slice()), s = new Oe(t).injector(), c = function (t) {
                    if (t instanceof Se) {
                        var e = t;
            ...
            var n = this.target(t, e, r), i = this.getCurrentPath();
            ...
            }, c = this.router.transitionService.create(i, n), f = c.run().catch(s(c));
            ...
            var n = this.getCurrentPath(), i = $e.makeTargetState(this.router.stateRegistry, n);
    ...
    }, Gr = {}, Wr = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm, zr = /([^\s,]+)/g, Jr = {
        get: function (t) {
            return Gr[t]
        }, has: function (t) {
            return null != Jr.get(t)
        }, invoke: function (t, e, r) {
            var n = L({}, Gr, r || {}), i = Jr.annotate(t), o = _t(function (t) {
    ...
    function Yr(t) {
        var e = function (t) {
            return t || ""
        }, r = Jt(t).map(e), n = r[0], i = r[1], o = Qt(n).map(e);
        return {path: o[0], search: o[1], hash: i, url: t}
    }

    var Zr = function (t) {
        var e = t.path(), r = t.search(), n = t.hash(), i = Object.keys(r).map(function (e) {
            var t = r[e];
    ...
    function Xr(n, i, o, a) {
        return function (t) {
            var e = t.locationService = new o(t), r = t.locationConfig = new a(t, i);
            return {
                name: n, service: e, configuration: r, dispose: function (t) {
    ...
    var tn, en, rn, nn = function () {
    ...
    }(), on = (tn = Object.setPrototypeOf || {__proto__: []} instanceof Array && function (t, e) {
        t.__proto__ = e
    } || function (t, e) {
    ...
    }(nn), un = (en = Object.setPrototypeOf || {__proto__: []} instanceof Array && function (t, e) {
        t.__proto__ = e
    } || function (t, e) {
        for (var r in e) e.hasOwnProperty(r) && (t[r] = e[r])
    }, function (t, e) {
    ...
    }(nn), cn = (rn = Object.setPrototypeOf || {__proto__: []} instanceof Array && function (t, e) {
        t.__proto__ = e
    } || function (t, e) {
        for (var r in e) e.hasOwnProperty(r) && (t[r] = e[r])
    }, function (t, e) {
        ...
        return cn(t, r), t.prototype._getBasePrefix = function () {
            ...
            n = Qt(n)[1], r = Jt(r)[1];
            var i = this._getBasePrefix(), o = e === this._config.baseHref(), a = e.substr(0, i.length) === i;
            return (e = o ? "/" : a ? e.substring(i.length) : e) + (n ? "?" + n : "") + (r ? "#" + r : "")
        }, t.prototype._set = function (t, e, r, n) {
            var i = this._getBasePrefix(), o = r && "/" !== r[0] ? "/" : "",
    ...
    function pn(t) {
        return A.$injector = Jr, {
            name: "vanilla.services", $q: A.$q = Br, $injector: Jr, dispose: function () {
                return null
            }
        }
    }

    var vn = Xr("vanilla.hashBangLocation", !1, an, hn), dn = Xr("vanilla.pushStateLocation", !0, fn, hn),
        mn = Xr("vanilla.memoryLocation", !1, sn, ln), yn = function () {
            function t() {
            }
    ...
    function Sn(n) {
        ...
        var a = {}, e = n.views || {$default: it(n, t)};
        return N(e, function (t, e) {
            if (e = e || "$default", P(t) && (t = {component: t}), t = L({}, t), _n(i, t) && _n(o, t)) throw new Error("Cannot combine: " + i.join("|") + " with: " + o.join("|") + " in stateview: '" + e + "@" + n.name + "'");
    ...
    var $n = 0, bn = function () {
        ...
        return t.prototype.load = function () {
            var e = this, t = A.$q, r = new Oe(this.path), n = this.path.reduce(function (t, e) {
                return L(t, e.paramValues)
            }, {}), i = {
            ...
            var r = A.$injector.annotate(e), n = O(e) ? Ct(e) : e;
        ...
        return t.prototype.useHttpService = function (t) {
            ...
            var n = A.$injector.annotate(t), i = O(t) ? Ct(t) : t;
            ...
            f = f || {};
            var l = 3 <= b.version.minor ? "::" : "", h = function (t) {
                var e = Ut(t);
                ...
                var e = t.name, r = t.type, n = h(e);
                if (s.attr(n) && !f[e]) return n + "='" + s.attr(n) + "'";
                var i = f[e] || e;
                if ("@" === r) return n + "='{{" + l + "$resolve." + i + "}}'";
                if ("&" === r) {
                    var o = c.getResolvable(i), a = o && o.data, u = a && A.$injector.annotate(a) || [];
    ...
    var En = function (t) {
        ...
        return function (t, e) {
            var i = t[r], o = "onExit" === r ? "from" : "to";
            return i ? function (t, e) {
                var r = new Oe(t.treeChanges(o)).subContext(e.$$state()), n = L(Gn(r), {$state$: e, $transition$: t});
        ...
        return r.injectableHandler = function (e, r) {
            ...
            var e = this, r = this.router.urlService.rules;
            if (P(t)) r.otherwise(t); else {
    ...
    var xn = b.module("ui.router.init", ["ng"]), jn = b.module("ui.router.util", ["ui.router.init"]),
    ...
    function zn(t) {
        var e = t.parent().inheritedData("$uiView"), r = R("$cfg.path")(e);
    ...
    function ti(d, m, y, t, g, e) {
        var w = R("viewDecl.controllerAs"), _ = R("viewDecl.resolveAs");
        return {
            restrict: "ECA", priority: -400, compile: function (t) {
                var v = t.html();
                return t.empty(), function (e, r) {
                    var t = r.data("$uiView");
                    if (!t) return r.html(v), void d(r.contents())(e);
                    var n = t.$cfg || {viewDecl: {}, getTemplate: G}, i = n.path && new Oe(n.path);
                    r.html(n.getTemplate(r, i) || v), ce.traceUIViewFill(t.$uiView, r.html());
                    var o = d(r.contents()), a = n.controller, u = w(n), s = _(n), c = i && Gn(i);
                    if (e[s] = c, a) {
                    ...
                    if (P(n.component)) var l = Ut(n.component), h = new RegExp("^(x-|data-)?" + l + "$", "i"),
                        p = e.$watch(function () {
    ...
    Nn = ["$uiRouter", "$timeout", function (h, p) {
        ...
        return {
            restrict: "A", require: ["?^uiSrefActive", "?^uiSrefActiveEq"], link: function (t, e, r, n) {
                var i, o = Qn(e), a = n[1] || n[0], u = null, s = {}, c = function () {
                    return Jn(v, e, s)
                }, f = Wn(r.uiSref);
        ...
        return {
            restrict: "A", require: ["?^uiSrefActive", "?^uiSrefActiveEq"], link: function (r, t, n, e) {
                var i, o = Qn(t), a = e[1] || e[0], u = null, s = {}, c = function () {
                    return Jn(d, t, s)
                }, f = ["uiState", "uiStateParams", "uiStateOpts"], l = f.reduce(function (t, e) {
                    return t[e] = G, t
                }, {});
        ...
        return {
            restrict: "A", controller: ["$scope", "$element", "$attrs", function (u, s, t) {
                var c, n, e, r, i, f = [];
                ...
                function p() {
                    ...
                    }, r = t(f).concat(e(c)).reduce(yt, []), n = t(f.filter(function (t) {
                        return v.includes(t.state.name, t.params)
                    })), i = !!f.filter(function (t) {
                        return v.is(t.state.name, t.params)
                    }).length ? e(c) : [], o = n.concat(i).reduce(yt, []), a = r.filter(function (t) {
                        return !J(o, t)
                    });
        ...
        var S = {$cfg: {viewDecl: {$context: i._pluginapi._rootViewContext()}}, $uiView: {}}, $ = {
            ...
            compile: function (t, e, y) {
                return function (a, u, t) {
                    var s, c, f, l, e, h = t.onload || "", p = t.autoscroll, v = {
                    ...
                    }, r = u.inheritedData("$uiView") || S, d = w(t.uiView || t.name || "")(a) || "$default", m = {
                        $type: "ng1",
                        id: $.count++,
                        name: d,
                        ...
                        get creationContext() {
                            var t = R("$cfg.viewDecl.$context")(r), e = R("$uiView.creationContext")(r);
                            return t || e
                        }
                    };

                    function n(t) {
                        var e = a.$new(), r = _.defer(), n = _.defer(), i = {$cfg: t, $uiView: m},
                    ...
                    ce.traceUIViewEvent("Linking", m), u.data("$uiView", {$uiView: m}), n(), e = i.registerUIView(m), a.$on("$destroy", function () {
    ...
    var ei = "function" == typeof b.module("ui.router").component, ri = 0;

    function ni(n, t, c, e, r) {
        !C(c.$onInit) || r.viewDecl.component && ei || c.$onInit();
        var f = Ct(r.path).state.self, i = {bind: c};
        if (C(c.uiOnParamsChanged)) {
            ...
            e.$on("$destroy", t.onSuccess({}, function (t) {
                if (t !== l && -1 === t.exiting().indexOf(f)) {
                    var r = t.params("to"), n = t.params("from"), e = function (t) {
                            return t.paramSchema
                        }, i = t.treeChanges("to").map(e).reduce(vt, []), o = t.treeChanges("from").map(e).reduce(vt, []),
        ...
        if (C(c.uiCanExit)) {
            var o = ri++, a = "_uiCanExitIds", u = function (t) {
